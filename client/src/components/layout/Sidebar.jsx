...
import { LayoutDashboard, Users, UserCheck, DollarSign, CalendarCheck, Shield, BarChart3, ClipboardList } from 'lucide-react';
...
const Sidebar = ({ isMobileOpen, closeMobile }) => {
  ...
  const navItems = [
    ...
    { name: 'User Management', path: '/users', icon: Shield, roles: ['admin'] },
